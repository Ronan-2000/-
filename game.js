...
function gameOver() {
    ...
    dialog.className = 'game-over-dialog'; // 添加类名以便于选择
    ...
    dialog.innerHTML = `
        <h2 style="margin: 0 0 20px; color: #1d1d1f;">游戏结束</h2>
        <p style="font-size: 18px; margin: 0 0 25px;">最终得分：${finalScore}</p>
    ...
    if (restartButton) {
        restartButton.onclick = function() {
            // 确保对话框被移除
            const dialogs = document.querySelectorAll('.game-over-dialog');
